...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "whitespace-wrap focus:outline-main-green data-[placeholder]:text-additional-gray group flex w-full max-w-[480px] items-center justify-between rounded-lg bg-main-bg px-4 py-4 text-sm shadow-sm",
      "data-[state=error]:border-error-red data-[state=error]:focus:border-error-red data-[state=error]:border-2",
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="relative -right-1 h-6 w-6 text-main-black transition-transform duration-200 group-data-[state=open]:rotate-180" />
